...
"#;
        match parse(code) {
            Ok(result) => {
                assert_eq!(
                    format!("{:?}", result),
                    "Program { module: [Func(Function(Void, [TypedIdent { ty: Int32, id: Some(\"n\") }, TypedIdent { ty: Char, id: Some(\"pos1\") }, TypedIdent { ty: Char, id: Some(\"pos3\") }]), \"move\", Some(Block([Expr(Call(Var(\"printf\"), [String(\"盘子%d: 从 %c柱 移动到 %c柱\\\\n\"), Var(\"n\"), Var(\"pos1\"), Var(\"pos3\")]))]))), Func(Function(Void, [TypedIdent { ty: Int32, id: Some(\"n\") }, TypedIdent { ty: Char, id: Some(\"pos1\") }, TypedIdent { ty: Char, id: Some(\"pos2\") }, TypedIdent { ty: Char, id: Some(\"pos3\") }]), \"Hanoi\", Some(Block([If(Binary(Eq, Var(\"n\"), Int32(1)), Block([Expr(Call(Var(\"move\"), [Var(\"n\"), Var(\"pos1\"), Var(\"pos3\")]))]), Some(Block([Expr(Call(Var(\"Hanoi\"), [Binary(Sub, Var(\"n\"), Int32(1)), Var(\"pos1\"), Var(\"pos3\"), Var(\"pos2\")])), Expr(Call(Var(\"move\"), [Var(\"n\"), Var(\"pos1\"), Var(\"pos3\")])), Expr(Call(Var(\"Hanoi\"), [Binary(Sub, Var(\"n\"), Int32(1)), Var(\"pos2\"), Var(\"pos1\"), Var(\"pos3\")]))])))]))), Func(Function(Int32, []), \"main\", Some(Block([Decl(Var(Int32, \"n\", Some(Int32(3)))), Decl(Var(Char, \"pos1\", Some(Char('A')))), Decl(Var(Char, \"pos2\", Some(Char('B')))), Decl(Var(Char, \"pos3\", Some(Char('C')))), Expr(Call(Var(\"printf\"), [String(\"移动%d个盘子的步骤如下↓\\\\n\"), Var(\"n\")])), Expr(Call(Var(\"Hanoi\"), [Var(\"n\"), Var(\"pos1\"), Var(\"pos2\"), Var(\"pos3\")])), Return(Some(Int32(0)))])))] }"
                )
            }
            Err(err) => match err {
                FrontendError::ParseError(s) => panic!("{}", s),
